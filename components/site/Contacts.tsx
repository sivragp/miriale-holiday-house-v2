        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          <div className={`mt-8 ${cardRail} md:grid-cols-3`}>
            <a href={telLink} className="rounded-2xl border border-line bg-paper p-6 text-center shadow-sm transition hover:shadow-card">
              ...
              <h3 className="mt-3 font-semibold text-deep-brown">{tr(lang, { it: "Chiamaci", en: "Call us", es: "Llámanos" })}</h3>
              <p className="mt-1 font-semibold text-terracotta">{WHATSAPP_DISPLAY}</p>
              <p className="mt-2 text-xs text-warm-gray">{tr(lang, { it: "Tutti i giorni · risposta rapida", en: "Every day · quick reply", es: "Todos los días · respuesta rápida" })}</p>
            ...
            <a href={mailto} className="rounded-2xl border border-line bg-paper p-6 text-center shadow-sm transition hover:shadow-card">
              ...
              <h3 className="mt-3 font-semibold text-deep-brown">{tr(lang, { it: "Scrivici una email", en: "Email us", es: "Escríbenos un email" })}</h3>
              <p className="mt-1 font-semibold text-terracotta">{EMAIL}</p>
              <p className="mt-2 text-xs text-warm-gray">{tr(lang, { it: "Di solito rispondiamo in poche ore", en: "We usually reply within a few hours", es: "Normalmente respondemos en pocas horas" })}</p>
            </a>
            <a href={MAPS_SHORT} target="_blank" rel="noopener noreferrer" className="rounded-2xl border border-line bg-paper p-6 text-center shadow-sm transition hover:shadow-card">
              ...
              <h3 className="mt-3 font-semibold text-deep-brown">{tr(lang, { it: "Vieni a trovarci", en: "Write to us", es: "Ven a visitarnos" })}</h3>
              ...
              <p className="mt-2 text-xs text-warm-gray">{tr(lang, { it: "Zona residenziale, tranquilla e sicura", en: "Residential area, quiet and safe", es: "Zona residencial, tranquila y segura" })}</p>
            </a>
          </div>
        </div>
      </section>
