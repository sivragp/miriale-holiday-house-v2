...
export default function HomeMiriale() {
  ...
  const stats: { Icon: typeof Plane; a: B; b: B }[] = [
    { Icon: Plane, a: { it: "10 min", en: "10 min", es: "10 min" }, b: { it: "dall'aeroporto FCO", en: "to FCO Airport", es: "del aeropuerto FCO" } },
    { Icon: HomeIcon, a: { it: "2", en: "2", es: "2" }, b: { it: "appartamenti", en: "apartments", es: "apartamentos" } },
    { Icon: Users, a: { it: "Fino a 10", en: "Up to 10", es: "Hasta 10" }, b: { it: "ospiti", en: "guests", es: "huéspedes" } },
    { Icon: SquareParking, a: { it: "Gratis", en: "Free", es: "Gratis" }, b: { it: "parcheggio", en: "parking", es: "aparcamiento" } },
    { Icon: Leaf, a: { it: "Privato", en: "Private", es: "Privado" }, b: { it: "giardino", en: "garden", es: "jardín" } },
    { Icon: Star, a: { it: "8.8/10", en: "8.8/10", es: "8.8/10" }, b: { it: "da 129 recensioni", en: "From 129 reviews", es: "De 129 reseñas" } },
  ];

  const stays: { apt: typeof miri; img: string; tab: B; tabColor: string; titolo: B; descr: B; best: B; href: string }[] = [
    { apt: miri, img: "/images/house/house-10.jpg", tab: { it: "Appartamento Miri", en: "Miri apartment", es: "Apartamento Miri" }, tabColor: "#0fa9b8", titolo: { it: "Spazioso e accogliente", en: "Spacious & warm", es: "Espacioso y acogedor" }, descr: { it: "Appartamento al primo piano con cucina in legno e soggiorno, due camere matrimoniali e spazi comodi per un soggiorno rilassante.", en: "First-floor apartment with wooden kitchen living room, two double bedrooms and comfortable spaces for a relaxing stay.", es: "Apartamento en la primera planta con cocina de madera y salón, dos habitaciones dobles y espacios cómodos para una estancia relajante." }, best: { it: "Ideale per famiglie, coppie e amici fino a 6", en: "Best for families, couples and friends up to 6", es: "Ideal para familias, parejas y amigos hasta 6" }, href: "/miri" },
    { apt: ale, img: "/images/house/house-09.jpg", tab: { it: "Appartamento Ale", en: "Ale apartment", es: "Apartamento Ale" }, tabColor: "#1e88b5", titolo: { it: "Mansarda luminosa", en: "Bright attic loft", es: "Buhardilla luminosa" }, descr: { it: "Mansarda all'ultimo piano con soffitti spioventi, bagno moderno in marmo e cucina completamente attrezzata.", en: "Top-floor attic/loft with sloped ceilings, modern marble bathroom and fully equipped kitchen.", es: "Buhardilla en la última planta con techos abuhardillados, baño moderno de mármol y cocina totalmente equipada." }, best: { it: "Ideale per coppie, piccole famiglie e soggiorni di lavoro", en: "Best for couples, small families and business stays", es: "Ideal para parejas, familias pequeñas y estancias de trabajo" }, href: "/ale" },
    { apt: casa, img: "/images/house/house-22.jpg", tab: { it: "Casa intera", en: "Whole house", es: "Casa entera" }, tabColor: "#0f3d4a", titolo: { it: "Insieme, tutti", en: "Stay together", es: "Todos juntos" }, descr: { it: "Prenota entrambi gli appartamenti e goditi tutta la casa: 4 camere, 2 cucine e il giardino privato.", en: "Book both apartments and enjoy the whole house: 4 bedrooms, 2 kitchens and the private garden.", es: "Reserva ambos apartamentos y disfruta de toda la casa: 4 habitaciones, 2 cocinas y el jardín privado." }, best: { it: "Ideale per gruppi e famiglie fino a 10 ospiti", en: "Best for groups and families up to 10 guests", es: "Ideal para grupos y familias hasta 10 huéspedes" }, href: "/la-casa" },
  ];

  const gardenChecks: B[] = [
    { it: "Giardino privato a tuo uso esclusivo", en: "Private garden for your exclusive use", es: "Jardín privado para tu uso exclusivo" },
    { it: "Terrazza per la colazione e sedute all'aperto", en: "Breakfast terrace and outdoor seating", es: "Terraza para el desayuno y asientos al aire libre" },
    { it: "Verde, tranquillo e perfetto per rilassarsi", en: "Green, quiet and perfect to unwind", es: "Verde, tranquilo y perfecto para relajarse" },
    { it: "Parcheggio gratuito in loco, dentro la proprietà", en: "On-site free parking inside the property", es: "Aparcamiento gratuito en el lugar, dentro de la propiedad" },
  ];
  ...
  const hostChecks: { Icon: typeof UserCheck; t: B }[] = [
    { Icon: UserCheck, t: { it: "Check-in di persona e consigli locali", en: "In-person check-in and local tips", es: "Check-in en persona y consejos locales" } },
    { Icon: Luggage, t: { it: "Aiuto coi bagagli e supporto parcheggio", en: "Luggage help and parking support", es: "Ayuda con el equipaje y apoyo con el aparcamiento" } },
    { Icon: Coffee, t: { it: "Caffè al mattino offerto", en: "Complimentary morning coffee", es: "Café por la mañana de cortesía" } },
    { Icon: Plane, t: { it: "Transfer aeroporto su richiesta (a pagamento)", en: "Airport transfer on request (paid service)", es: "Traslado al aeropuerto bajo petición (servicio de pago)" } },
    { Icon: Users, t: { it: "Parliamo italiano, inglese e spagnolo", en: "We speak Italian, English and Spanish", es: "Hablamos italiano, inglés y español" } },
  ];
  ...
  const places: { Icon: typeof Plane; t: B; rows: { p: B; d: B; car?: boolean }[] }[] = [
    { Icon: Plane, t: { it: "Aeroporti", en: "Airports", es: "Aeropuertos" }, rows: [
      { p: { it: "Aeroporto di Roma Fiumicino (FCO)", en: "Rome Fiumicino Airport (FCO)", es: "Aeropuerto de Roma Fiumicino (FCO)" }, d: { it: "5 km", en: "5 km", es: "5 km" }, car: true },
      { p: { it: "Aeroporto di Roma Ciampino", en: "Rome Ciampino Airport", es: "Aeropuerto de Roma Ciampino" }, d: { it: "31 km", en: "31 km", es: "31 km" }, car: true },
    ] },
    { Icon: Train, t: { it: "Roma e treni", en: "Rome & trains", es: "Roma y trenes" }, rows: [
      { p: { it: "Bus pubblico (verso FCO e Ostia)", en: "Public bus (to FCO and Ostia)", es: "Autobús público (hacia FCO y Ostia)" }, d: { it: "500 m a piedi", en: "500 m walk", es: "500 m a pie" } },
      { p: { it: "Treno Lido Nord / Ostia Nord", en: "Lido Nord / Ostia Nord train", es: "Tren Lido Nord / Ostia Nord" }, d: { it: "5 km", en: "5 km", es: "5 km" }, car: true },
      { p: { it: "Roma centro (in auto)", en: "Central Rome (by car)", es: "Centro de Roma (en coche)" }, d: { it: "~30 km", en: "~30 km", es: "~30 km" }, car: true },
    ] },
    { Icon: Waves, t: { it: "Spiagge", en: "Beaches", es: "Playas" }, rows: [
      { p: { it: "Lungomare della Salute", en: "Lungomare della Salute beach", es: "Playa del Lungomare della Salute" }, d: { it: "3,9 km", en: "3.9 km", es: "3,9 km" }, car: true },
      { p: { it: "Focene", en: "Focene", es: "Focene" }, d: { it: "4,7 km", en: "4.7 km", es: "4,7 km" }, car: true },
      { p: { it: "Ostia Lido", en: "Ostia Lido", es: "Ostia Lido" }, d: { it: "4,7 km", en: "4.7 km", es: "4,7 km" }, car: true },
      { p: { it: "Castel Fusano", en: "Castel Fusano", es: "Castel Fusano" }, d: { it: "7 km", en: "7 km", es: "7 km" }, car: true },
    ] },
    { Icon: Landmark, t: { it: "Cultura e natura", en: "Culture & nature", es: "Cultura y naturaleza" }, rows: [
      { p: { it: "Ostia Antica (scavi)", en: "Ostia Antica ruins", es: "Ostia Antica (excavaciones)" }, d: { it: "4,3 km", en: "4.3 km", es: "4,3 km" }, car: true },
      { p: { it: "Bosco Macchia Grande di Focene", en: "Macchia Grande di Focene woods", es: "Bosque Macchia Grande di Focene" }, d: { it: "11 km", en: "11 km", es: "11 km" }, car: true },
    ] },
    { Icon: Building2, t: { it: "Fiere ed eventi", en: "Fairs & events", es: "Ferias y eventos" }, rows: [
      { p: { it: "Fiera di Roma", en: "Fiera di Roma", es: "Fiera di Roma" }, d: { it: "7 km", en: "7 km", es: "7 km" }, car: true },
      { p: { it: "PalaLottomatica", en: "PalaLottomatica", es: "PalaLottomatica" }, d: { it: "22 km", en: "22 km", es: "22 km" }, car: true },
      { p: { it: "Metro EUR Fermi", en: "EUR Fermi metro", es: "Metro EUR Fermi" }, d: { it: "23 km", en: "23 km", es: "23 km" }, car: true },
    ] },
    { Icon: Fish, t: { it: "Ristoranti vicini", en: "Nearby restaurants", es: "Restaurantes cercanos" }, rows: [
      ...
      { p: { it: "Ristorante Docking 9", en: "Docking 9 restaurant", es: "Restaurante Docking 9" }, d: { it: "1,8 km", en: "1.8 km", es: "1,8 km" }, car: true },
    ] },
  ];

  const whoFor: { Icon: typeof Users; img: string; t: B }[] = [
    { Icon: Landmark, img: "/images/luoghi/roma-vittoriano.jpg", t: { it: "Turisti in visita a Roma e al mare", en: "Tourists visiting Rome and the sea", es: "Turistas que visitan Roma y el mar" } },
    { Icon: Plane, img: "/images/luoghi/scali.jpg", t: { it: "Voli presto o tardi e scali", en: "Early or late flights & stopovers", es: "Vuelos temprano o tarde y escalas" } },
    { Icon: GraduationCap, img: "/images/luoghi/fiera.jpg", t: { it: "Visitatori della Fiera di Roma o esami", en: "Visitors to Fiera di Roma or exams", es: "Visitantes de la Fiera di Roma o exámenes" } },
    { Icon: ShieldCheck, img: "/images/luoghi/guardia-finanza.jpg", t: { it: "Visite ufficiali Guardia di Finanza e famiglie", en: "Guardia di Finanza official visitors and families", es: "Visitas oficiales de la Guardia di Finanza y familias" } },
    { Icon: Users, img: "/images/luoghi/famiglie.jpg", t: { it: "Famiglie e gruppi fino a 10 ospiti", en: "Families & groups up to 10 guests", es: "Familias y grupos hasta 10 huéspedes" } },
  ];

  const comforts: { Icon: typeof Wifi; t: B }[] = [
    { Icon: Wifi, t: { it: "Wi-Fi gratuito", en: "Free Wi-Fi", es: "Wi-Fi gratuito" } },
    { Icon: Wind, t: { it: "Aria condizionata e riscaldamento", en: "Air conditioning & heating", es: "Aire acondicionado y calefacción" } },
    { Icon: CookingPot, t: { it: "Cucine completamente attrezzate", en: "Fully equipped kitchens", es: "Cocinas totalmente equipadas" } },
    { Icon: Tv, t: { it: "TV a schermo piatto", en: "Flat-screen TV", es: "TV de pantalla plana" } },
    { Icon: WashingMachine, t: { it: "Lavatrice", en: "Washing machine", es: "Lavadora" } },
    { Icon: Coffee, t: { it: "Moka per il caffè", en: "Moka coffee pot", es: "Cafetera moka" } },
    { Icon: Fan, t: { it: "Phon", en: "Hair dryer", es: "Secador de pelo" } },
    { Icon: Plane, t: { it: "Navetta aeroporto (a pagamento)", en: "Airport shuttle (paid)", es: "Servicio de traslado al aeropuerto (de pago)" } },
    { Icon: Baby, t: { it: "Culla su richiesta", en: "Baby cot on request", es: "Cuna bajo petición" } },
    { Icon: SquareParking, t: { it: "Parcheggio privato gratuito", en: "Free private parking", es: "Aparcamiento privado gratuito" } },
  ];

  const area: { img: string; t: B; s: B }[] = [
    { img: "/images/luoghi/roma.jpg", t: { it: "Roma", en: "Rome", es: "Roma" }, s: { it: "storia, arte e cultura", en: "history, art & culture", es: "historia, arte y cultura" } },
    { img: "/images/luoghi/beach.jpg", t: { it: "Vita da spiaggia", en: "Beach life", es: "Vida de playa" }, s: { it: "sole, mare e relax", en: "sun, sea & relaxation", es: "sol, mar y relax" } },
    { img: "/images/luoghi/pesce.jpg", t: { it: "Cene di pesce", en: "Seafood dinners", es: "Cenas de pescado" }, s: { it: "fresco e gustoso", en: "fresh & delicious", es: "fresco y sabroso" } },
    { img: "/images/luoghi/ostia.jpg", t: { it: "Ostia Antica", en: "Ostia Antica", es: "Ostia Antica" }, s: { it: "antica città romana", en: "ancient Roman city", es: "antigua ciudad romana" } },
    { img: "/images/luoghi/tramonto.jpg", t: { it: "Tramonto sul mare", en: "Sunset by the sea", es: "Atardecer junto al mar" }, s: { it: "momenti indimenticabili", en: "unforgettable moments", es: "momentos inolvidables" } },
  ];
  ...
  const rules: { Icon: typeof CalendarCheck; t: B; s: B }[] = [
    ...
    { Icon: MoonStar, t: { it: "Silenzio", en: "Quiet time", es: "Silencio" }, s: { it: "23:00 – 07:00", en: "23:00 – 07:00", es: "23:00 – 07:00" } },
    { Icon: PawPrint, t: { it: "Animali", en: "Pets", es: "Mascotas" }, s: { it: "non ammessi", en: "not allowed", es: "no admitidas" } },
  ];

  const goodToKnow: B[] = [
    { it: "Pagamento in loco al check-in (nessun pagamento online)", en: "Payment on arrival at check-in (no online payment)", es: "Pago en el lugar en el check-in (sin pago online)" },
    { it: "Bambini di tutte le età benvenuti · culla su richiesta (€10/soggiorno)", en: "Children of all ages welcome · baby cot on request (€10/stay)", es: "Niños de todas las edades bienvenidos · cuna bajo petición (€10/estancia)" },
    { it: "Documenti d'identità richiesti al check-in", en: "ID documents required at check-in", es: "Documentos de identidad requeridos en el check-in" },
    { it: "Eventuale tassa di soggiorno comunale, da saldare in loco", en: "Any municipal tourist tax payable on site", es: "Posible tasa de estancia municipal, a pagar en el lugar" },
  ];
    ...
    <main className="flex-1">
          ...
          <div className="order-2 md:order-1">
            ...
            <p className="mt-5 max-w-md text-sm leading-relaxed text-warm-gray">
              {tr(lang, {
                ...
                es: "Casa vacacional de gestión familiar en una zona tranquila de Fiumicino. Dos apartamentos independientes o la casa entera, ideales para escalas, escapadas a la ciudad y estancias en familia.",
              })}
            </p>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a href={waLink()} target="_blank" rel="noopener noreferrer" className="inline-flex flex-col items-center rounded-full px-6 py-2.5 text-white shadow-sm transition hover:opacity-90" style={{ backgroundColor: "#25d366" }}>
                ...
                <span className="text-[10px] text-white/90">{tr(lang, { it: "Miglior prezzo, nessuna commissione", en: "Best price, no fees", es: "Mejor precio, sin comisiones" })}</span>
              </a>
              <ContactFormModal
                renderTrigger={(open) => (
                  <button type="button" onClick={open} aria-haspopup="dialog" aria-label="Email" className="inline-flex flex-col items-center rounded-full px-6 py-2.5 text-white shadow-sm transition hover:opacity-90" style={{ backgroundColor: GMAIL_BLUE }}>
                    ...
                    <span className="text-[10px] text-white/90">{tr(lang, { it: "Ti rispondiamo presto", en: "We reply soon", es: "Te respondemos pronto" })}</span>
                  </button>
                )}
              />
              <Link href="#apartments" className="inline-flex items-center gap-2 rounded-full border border-terracotta px-6 py-3 text-sm font-semibold text-terracotta transition hover:bg-terracotta hover:text-white">
                {tr(lang, { it: "Scopri gli appartamenti", en: "Explore the apartments", es: "Descubre los apartamentos" })}
              </Link>
            </div>
            <p className="mt-4 flex items-start gap-2 text-xs text-warm-gray">
              ...
              {tr(lang, { it: "Prenotazione diretta, nessun pagamento online. Paghi al check-in: semplice e sicuro.", en: "Direct booking, no online payment. Pay at check-in. It's simple and safe.", es: "Reserva directa, sin pago online. Pagas en el check-in: sencillo y seguro." })}
            </p>
          </div>
      ...
      <section id="apartments" className="relative overflow-hidden bg-cover bg-center py-12 md:py-14" style={{ backgroundImage: "url('/images/luoghi/teal-water.jpg')" }}>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <Reveal className="text-center">
            <p className="font-script text-2xl leading-none text-white drop-shadow">{tr(lang, { it: "Scegli il tuo soggiorno", en: "Choose your stay", es: "Elige tu estancia" })}</p>
            <h2 className="mt-1 font-serif text-2xl font-bold italic text-white drop-shadow md:text-3xl">{tr(lang, { it: "Due appartamenti, una casa", en: "Two apartments, one house", es: "Dos apartamentos, una casa" })}</h2>
              ...
              <article key={s.href} className="flex flex-col overflow-hidden rounded-2xl border border-line bg-paper shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-card">
                ...
                <div className="flex flex-1 flex-col p-4 sm:p-5">
                  <div className="flex flex-wrap gap-x-3 gap-y-1 border-b border-line-soft pb-3 text-xs text-warm-gray">
                    ...
                    <span className="flex items-center gap-1"><Users className="h-3.5 w-3.5 text-terracotta" /> {s.apt.camere} {tr(lang, { it: "matrimoniali", en: "double bedrooms", es: "habitaciones dobles" })}</span>
                    <span className="flex items-center gap-1"><Waves className="h-3.5 w-3.5 text-terracotta" /> {s.apt.bagni} {tr(lang, { it: s.apt.bagni > 1 ? "bagni" : "bagno", en: s.apt.bagni > 1 ? "bathrooms" : "bathroom", es: s.apt.bagni > 1 ? "baños" : "baño" })}</span>
                  </div>
                  ...
                  <div className="mt-4 flex items-center justify-between gap-3 pt-2">
                    ...
                    <Link href={s.href} className="flex-shrink-0 rounded-full border border-terracotta px-4 py-2 text-xs font-semibold text-terracotta transition hover:bg-terracotta hover:text-white">{tr(lang, { it: "Dettagli", en: "View details", es: "Ver detalles" })}</Link>
                  </div>
                </div>
              </article>
            ))}
          ...
          <p className="mx-auto mt-6 flex max-w-3xl items-center justify-center gap-2 rounded-full bg-paper px-5 py-3 text-center text-sm text-warm-gray shadow-sm">
            <Heart className="h-4 w-4 flex-shrink-0 text-terracotta" /> {tr(lang, { it: "L'unico spazio condiviso è il giardino privato con terrazza per la colazione, sedute e parcheggio gratuito.", en: "The only shared area is the private garden with breakfast terrace, seating and free parking.", es: "El único espacio compartido es el jardín privado con terraza para el desayuno, asientos y aparcamiento gratuito." })}
          </p>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-paper py-12 md:py-14">
        <div className="mx-auto grid max-w-7xl items-center gap-8 px-6 md:grid-cols-2 md:gap-12">
          ...
          <div>
            <p className={eyebrow}>{tr(lang, { it: "Il tuo spazio all'aperto", en: "Your private outdoor space", es: "Tu espacio al aire libre" })}</p>
            <h2 className={`mt-1 ${sectionTitle}`}>{tr(lang, { it: "Rilassati nel nostro giardino", en: "Relax in our garden", es: "Relájate en nuestro jardín" })}</h2>
      ...
      <section id="recensioni" className="bg-cream py-12 md:py-14">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-8 lg:grid-cols-[280px_1fr] lg:gap-12">
            <div>
              <p className={eyebrow}>{tr(lang, { it: "Perché gli ospiti amano", en: "Why guests love", es: "Por qué a los huéspedes les encanta" })}</p>
              ...
              <p className="mt-1 text-sm text-warm-gray">{tr(lang, { it: "Favoloso · da 129 recensioni", en: "Fabulous · from 129 reviews", es: "Fabuloso · de 129 reseñas" })}</p>
            ...
            <div>
              ...
              <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                <Link href="/recensioni" className="inline-flex items-center gap-2 text-sm font-semibold text-terracotta hover:underline">
                  {tr(lang, { it: "Leggi tutte le 129 recensioni →", en: "Read all 129 reviews →", es: "Lee todas las 129 reseñas →" })}
                </Link>
      ...
      <section className="bg-paper py-12 md:py-14">
        <div className="mx-auto grid max-w-7xl items-stretch gap-6 px-6 lg:grid-cols-[1fr_1fr_0.7fr] lg:gap-8">
          ...
          <div className="flex flex-col justify-center">
            <p className={eyebrow}>{tr(lang, { it: "Conosci il tuo host", en: "Meet your host", es: "Conoce a tu anfitrión" })}</p>
            <h2 className={`mt-1 ${sectionTitle}`}>{tr(lang, { it: "Ciao, siamo Fabio e famiglia!", en: "Hi, we're Fabio and family!", es: "¡Hola, somos Fabio y familia!" })}</h2>
            <p className="mt-3 text-sm leading-relaxed text-warm-gray">{tr(lang, { it: "Viviamo a Fiumicino e accogliamo personalmente ogni ospite. Siamo sempre disponibili per rendere il tuo soggiorno facile e piacevole.", en: "We live here in Fiumicino and personally welcome every guest. We are always available to make your stay easy and enjoyable.", es: "Vivimos en Fiumicino y recibimos personalmente a cada huésped. Siempre estamos disponibles para que tu estancia sea fácil y agradable." })}</p>
          ...
          <div className="flex flex-col justify-center rounded-2xl border border-terracotta/20 bg-cream-2 p-6 text-center">
            ...
            <p className="mt-3 font-script text-lg text-terracotta">{tr(lang, { it: "A presto!", en: "See you soon!", es: "¡Hasta pronto!" })}</p>
      ...
      <section id="dove-siamo" className="bg-cream py-12 md:py-14">
        <div className="mx-auto max-w-7xl px-6">
          <Reveal className="text-center">
            <p className={eyebrow}>{tr(lang, { it: "In posizione perfetta", en: "Perfectly located", es: "En una ubicación perfecta" })}</p>
            <h2 className={`mt-1 ${sectionTitle}`}>{tr(lang, { it: "Vicino a tutto ciò che conta", en: "Close to everything that matters", es: "Cerca de todo lo que importa" })}</h2>
            <Wave className="mx-auto mt-2 h-2 w-16 text-terracotta" />
          </Reveal>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center rounded-2xl bg-paper px-6 py-4 text-center text-sm text-warm-gray shadow-sm">
            {[
              { it: "Zona residenziale tranquilla", en: "Quiet residential area", es: "Zona residencial tranquila" },
              { it: "Aeroporto FCO a 5 km", en: "FCO Airport 5 km away", es: "Aeropuerto FCO a 5 km" },
              { it: "Ristoranti a 700 m", en: "Restaurants 700 m away", es: "Restaurantes a 700 m" },
              { it: "Bus pubblico a 500 m", en: "Public bus 500 m away", es: "Autobús público a 500 m" },
            ].map((item, i) => (
      ...
      <section className="relative overflow-hidden bg-paper py-12 md:py-14">
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <Reveal className="text-center">
            <p className={eyebrow}>{tr(lang, { it: "Ideale per", en: "Ideal for", es: "Ideal para" })}</p>
            <h2 className={`mt-1 ${sectionTitle}`}>{tr(lang, { it: "Per chi siamo perfetti", en: "Who we're perfect for", es: "Para quién somos perfectos" })}</h2>
            <Wave className="mx-auto mt-2 h-2 w-16 text-terracotta" />
          </Reveal>
      ...
      <section id="servizi" className="bg-cream py-12 md:py-14">
        <div className="mx-auto max-w-7xl px-6">
          <Reveal className="text-center">
            <h2 className={sectionTitle}>{tr(lang, { it: "Tutti i comfort che ti servono", en: "All the comforts you need", es: "Todas las comodidades que necesitas" })}</h2>
            <Wave className="mx-auto mt-2 h-2 w-16 text-terracotta" />
          </Reveal>
      ...
      <section className="relative overflow-hidden bg-paper py-12 md:py-14">
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <Reveal className="text-center">
            <h2 className={sectionTitle}>{tr(lang, { it: "Vivi il meglio della zona", en: "Experience the best of the area", es: "Vive lo mejor de la zona" })}</h2>
            <Wave className="mx-auto mt-2 h-2 w-16 text-terracotta" />
          </Reveal>
          <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            {area.map((a) => (
      ...
      <section id="faq" className="relative overflow-hidden bg-cream py-12 md:py-14">
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
            <div>
              <h2 className={`text-center lg:text-left ${sectionTitle}`}>{tr(lang, { it: "Regole della casa e info pratiche", en: "House rules & practical info", es: "Normas de la casa e info práctica" })}</h2>
            ...
            <div className="rounded-2xl border border-line bg-paper p-6">
              <h3 className="font-serif text-lg font-bold text-deep-brown">{tr(lang, { it: "Buono a sapersi", en: "Good to know", es: "Bueno saber" })}</h3>
