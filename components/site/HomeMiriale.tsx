...
export default function HomeMiriale() {
  ...
  const stays: { apt: typeof miri; img: string; tab: B; tabColor: string; titolo: B; descr: B; best: B; href: string }[] = [
    { apt: miri, img: "/images/house/house-10.jpg", tab: { it: "Appartamento Miri", en: "Miri apartment" }, tabColor: "#0fa9b8", titolo: { it: "Spazioso e accogliente", en: "Spacious & warm" }, descr: { it: "Appartamento al primo piano con cucina in legno e soggiorno, due camere matrimoniali e spazi comodi per un soggiorno rilassante.", en: "First-floor apartment with wooden kitchen living room, two double bedrooms and comfortable spaces for a relaxing stay." }, best: { it: "Ideale per famiglie, coppie e amici fino a 6", en: "Best for families, couples and friends up to 6" }, href: "/miri" },
