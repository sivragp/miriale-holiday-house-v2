...
export default function HomeMiriale() {
  ...
  const stays: { apt: typeof miri; img: string; tab: B; tabColor: string; titolo: B; descr: B; best: B; href: string }[] = [
    { apt: miri, img: "/images/house/house-10.jpg", tab: { it: "Appartamento Miri", en: "Miri apartment", es: "Apartamento Miri" }, tabColor: "#0fa9b8", titolo: { it: "Spazioso e accogliente", en: "Spacious & warm", es: "Espacioso y acogedor" }, descr: { it: "Appartamento al piano terra con cucina in legno e soggiorno, due camere matrimoniali e spazi comodi per un soggiorno rilassante.", en: "Ground-floor apartment with wooden kitchen living room, two double bedrooms and comfortable spaces for a relaxing stay.", es: "Apartamento en la planta baja con cocina de madera y salón, dos habitaciones dobles y espacios cómodos para una estancia relajante." }, best: { it: "Ideale per famiglie, coppie e amici fino a 6", en: "Best for families, couples and friends up to 6", es: "Ideal para familias, parejas y amigos hasta 6" }, href: "/miri" },
