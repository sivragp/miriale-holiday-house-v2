...
export const APPARTAMENTI: Appartamento[] = [
  {
    ...
    stanze: [
      ...
      { nome: { it: "Camera 2", en: "Bedroom 2" }, tag: { it: "Toni caldi", en: "Warm tones" }, descr: { it: "Letto matrimoniale, armadio e aria condizionata.", en: "Double bed, wardrobe and air conditioning." }, imgs: [{ src: "/images/house/house-05.jpg", alt: "Camera 2" }] },
  ...
  },
  {
    ...
    stanze: [
      ...
      { nome: { it: "Cucina e zona pranzo", en: "Kitchen & dining" }, tag: { it: "Attrezzata", en: "Equipped" }, descr: { it: "Angolo cottura completo con tavolo da pranzo.", en: "Fully equipped kitchen with dining table." }, imgs: [{ src: "/images/house/house-38.jpg", alt: "Cucina" }, { src: "/images/house/house-27.jpg", alt: "Cucina" }] },
